...
| features | `daily: mean` |
| likelihoods | `mean=student_t` |
| active feature / lik | `mean` / `student_t` |
| n_points / overlap | `24` / `0.0` |
| n_model_events | `33` |
| MCMC | tune=6000, draws=3000, chains=4 |
| tau_map | `7` (conc. 0.309) |

Parameter pairs: `{'mu': ('mu_daily_mean_1', 'mu_daily_mean_2'), 'sigma': ('sigma_daily_mean_1', 'sigma_daily_mean_2'), 'alpha': None, 'beta': None, 'pi': None, 'nu': 'nu_daily_mean'}`
