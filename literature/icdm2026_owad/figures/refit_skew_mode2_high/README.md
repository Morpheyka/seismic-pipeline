...
| Field | Value |
|-------|-------|
| fingerprint | `65515c6970fa7603` |
| features | `daily: mean` |
| likelihoods | `mean=skew_normal` |
| active feature / lik | `mean` / `skew_normal` |
| n_points / overlap | `24` / `0.25` |
| n_model_events | `33` |
| MCMC | tune=6000, draws=3000, chains=4 |
| tau_map | `7` (conc. 0.493) |

Parameter pairs: `{'mu': ('mu_daily_mean_1', 'mu_daily_mean_2'), 'sigma': ('sigma_daily_mean_1', 'sigma_daily_mean_2'), 'alpha': ('alpha_daily_mean_1', 'alpha_daily_mean_2'), 'beta': None, 'pi': None, 'nu': None}`
